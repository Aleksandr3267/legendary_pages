...
function showResults(count) {
  ...
  if (currentIndex === count) {
    ...
    if (rightAnswers > count / 2 && rightAnswers < count) {
      ...
      theResults = `<span class="bad">Сиз сынактан өткөн жоксуз :(</span><span class="results_test_text">Результат теста</span> <span class="your_points">Ваши баллы: ${rightAnswers} из ${count}</span> <span class="passing_score">Проходной балл: 18 баллов</span>`;
    }
